  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold text-gray-900">Gestión de Presupuesto</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Presupuesto Mensual</h2>
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <span className="text-gray-600">Presupuesto Total:</span>
              <span className="font-semibold text-lg text-gray-900">$4,000.00</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-600">Gastado:</span>
              <span className="font-semibold text-lg text-red-600">$2,450.00</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-600">Restante:</span>
              <span className="font-semibold text-lg text-green-600">$1,550.00</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-3">
              <div className="bg-blue-600 h-3 rounded-full" style={{ width: '61.25%' }}></div>
            </div>
            <p className="text-sm text-gray-600">61.25% del presupuesto utilizado</p>
          </div>
        </div>
            ...
            {[
              ...
              <div key={week.week} className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm text-gray-600">${week.amount} / ${week.budget}</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div 
                    ...
                    style={{ width: `${Math.min((week.amount / week.budget) * 100, 100)}%` }}
                  ></div>
                </div>
              </div>
            ))}
      ...
      <div className="bg-white rounded-lg shadow-md">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">Presupuesto por Categoría</h2>
        </div>
        <div className="p-6">
          <div className="space-y-6">
            {[
